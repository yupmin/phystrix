 ...
 */
class ApcuMetricsPoller implements MetricsPollerInterface
{
    /**
     * @var Config
     */
    ...
    public function __construct(Config $config)
    {
        ...
        $stateStorage = new \Odesk\Phystrix\ApcuStateStorage();
    ...
    {
        $commandKeys = array();
        foreach (new APCUIterator('/^' . ApcStateStorage::CACHE_PREFIX . '/') as $counter) {
